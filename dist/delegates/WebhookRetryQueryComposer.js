...
exports.WebhookRetryQueryComposer = void 0;
class WebhookRetryQueryComposer {
    constructor(opts) {
    ...
    composeGetDueAttemptsSQL(nowEpochSecs) {
    ...
    composeHasSuccessfulExpiredWebhookSQL(storeId, invoiceId) {
        const sql = `
      SELECT 1
      FROM webhook_logs
      WHERE store_id = ?
...
exports.WebhookRetryQueryComposer = WebhookRetryQueryComposer;
//# sourceMappingURL=WebhookRetryQueryComposer.js.map