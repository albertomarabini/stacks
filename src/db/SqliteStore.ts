...
// better-sqlite3 has no bundled TS types in this project; import as any to avoid compile errors
...
export class SqliteStore implements ISqliteStore {
  // use any for the underlying DB instance to avoid depending on external typings
  ...
  constructor(db: any, codec?: IInvoiceIdCodec) {
    this.db = db;
    this.codec = codec;
  }
